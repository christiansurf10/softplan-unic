...
import { TrajectoryComponent } from 'app/entities/trajectory/trajectory.component';
...
describe('Component Tests', () => {
    describe('Trajectory Management Component', () => {
        let comp: TrajectoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TrajectoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.trajectories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
