...
import { ITrajectory, Trajectory } from 'app/shared/model/trajectory.model';
...
describe('Service Tests', () => {
    describe('Trajectory Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Trajectory', async () => {
